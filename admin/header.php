				...
				<div class="navbar-header pull-left">
					<a href="index.php" class="navbar-brand">
						<small>
							...
							<img src="../img/logo.png" height="40" width="80">|
							DT Collection
						</small>
					</a>
				</div>
					...
					<ul class="dropdown-menu-right dropdown-navbar navbar-pink dropdown-menu dropdown-caret dropdown-close">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img style="height: 60px;padding:2px;max-width: 100px;" class="nav-user-photo" src="../img/logo.png"  alt="CPC India..!"/>
				...
				<ul class="nav nav-list">
                    ...
                    <li class="<?php if($page_id=="home_page"){echo "active open";} ?>">
						...
						<ul class="submenu">
							...
							<li class="<?php if($sub_page_id=="latest_banner"){echo "active";} ?>">
								<a href="latest_banner.php">
									<i class="menu-icon fa fa-caret-right"></i>
									Latest banner
								</a>
								<b class="arrow"></b>
							...
							<li class="<?php if($sub_page_id=="testimonial"){echo "active";} ?>">
					...
					<li class="<?php if($page_id=="order_products"){echo "active open";} ?>">
						<a href="order_products.php">
							<i class="menu-icon fa fa-shopping-cart"></i>
							<span class="menu-text">Ordered Products</span>
						</a>
						<b class="arrow"></b>
					  </li>

...
if(isset($_GET['edt'])){
    $aa=$_GET['edt'];
    $ss="select * from latest_post where id='$aa'" ;
    $sss=$conn->query($ss);
    $res=$sss->fetch_assoc();
    }
...
if(isset($_POST['sub']))
{
    ...
    $s="update latest_post set title='$title',content='$content', image='$img_new_name' where id='$i'";

    if($conn->query($s)===TRUE)
    {
        echo "<script>alert('Latest Post Updated Successfully..!');window.location.href='latest_post.php';</script>";
    }
    else
    {
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Update Latest Post</li>
                        </ul><!-- /.breadcrumb -->
            ...
            <div class="panel-body">
                <form role="form" method="post" enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5 col-xs-5">
                            <textarea type="text" name="content" class="form-control datepicker" placeholder="NAME" required="" rows="3" cols="4"><?php echo $res['content']; ?></textarea>
                        </div>

...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title> Login - Dt Collection Admin </title>
				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<br><br><br><br>
							<div class="center">
								<img src="../img/logo.png" height="60px" width="140" style="border-radius: 5px;">
								<h4 class="blue" id="id-company-text">&copy; Welcome To  Dt Collection Admin Panel..!</h4>
							</div>

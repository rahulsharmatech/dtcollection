...
if(isset($_POST['submit']))
{
	...
	$s="INSERT INTO latest_post(title,content,image)VALUES('$title','$content','$img_new_name')";

    if($conn->query($s)===TRUE){
        echo "<script>alert('Latest Post Added Successfully..!');window.location.href='latest_post.php';</script>";
    }
        else
        {
...

{
	...
	$a=$_GET['del'];
	$s= "DELETE from latest_post where id='$a'" ;
	if($conn->query($s)===TRUE){
	 echo "<script>alert('My Journey Deleted Successfully..!'); window.location.href='latest_post.php';</script>"; }
	else
	{
	echo $conn->error;
	}
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Add Latest Post</li>
                        </ul><!-- /.breadcrumb -->
    ...
    <div class="col-xs-12 col-xs-12">           
        <div class="panel-primary">
            <div class="panel-heading modal-header">                            
                <h3 class="modal-title">ADD latest Post</h3>
            </div>
                ...
                <form role="form" method="post" enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-md-5 col-xs-5">
                            <textarea type="text" name="title" class="form-control datepicker" placeholder="Title" rows="3" cols="4" required=""></textarea>
                        </div>
                      
                        <label for="title" class="col-md-1 col-xs-1 label-control"> Content : </label>
                        <div class="col-md-5 col-xs-5">
                            <textarea type="text" name="content" class="form-control datepicker" placeholder="Content" rows="3" cols="4" required=""></textarea>
                        </div>
        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">View Latest Post </h3>
                </div>
                ...
                <div class="panel-body">                
                    ...
                    <!-- Selete Query -->
                        <?php
                            ...
                            $count=0;
                            $get = "SELECT * FROM latest_post ORDER BY id DESC";
                            $sql = $conn->query($get);
                        ...
                        ?>
                            <tr>
                                ...
                                <td><img src="../images/<?php echo $sqli['image'];?>" style="height:250px;width:300px;"></td> 
                                  <td>

                                   <a class="red" href="latest_post.php?del=<?php echo $sqli['id'];?>" onclick="return confirm('Are You Sure')"><i class="fa fa-trash" style="font-size:1.5em"></i></a>

                                   <a class="blue" href="latest_post_update.php?edt=<?php echo $sqli['id'];?>"><i class="fa fa-edit" style="font-size:1.5em"></i></a>

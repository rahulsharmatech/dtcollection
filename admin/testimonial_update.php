...
if(isset($_GET['edt']))
   ...
   {
    $aa=$_GET['edt'];
    $ss="select * from testimonial where id='$aa'" ;
    $sss=$conn->query($ss);
    $res=$sss->fetch_assoc();
    }
...
$s="update testimonial set name='$name',content='$content',image='$img_new_name' where id='$i'";

    if($conn->query($s)===TRUE)
    {
        echo "<script>alert('Updation Successfull..!');window.location.href='testimonials.php';</script>";
    }
    else
    {
            ...
            <div class="panel-body">
                <form role="form" method="post" enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
                    ...
                    <input type="hidden" name="image" value="<?php echo $res['image']; ?>">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-3 col-xs-3">
                            <textarea type="text" name="name" class="form-control datepicker" placeholder="Enter name" rows="3" cols="6" required=""><?php echo $res['name'] ?></textarea>
                        </div>


                        <label for="title" class="col-md-1 col-xs-1 label-control"> Content : </label>
                        <div class="col-md-7 col-xs-7">
                            <textarea type="text" name="content" class="form-control datepicker" placeholder="Content" rows="3" cols="6" required=""><?php echo $res['content']; ?></textarea>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <img height="150px" width="150px" src="../img/<?php echo $res['image'];?>" id="output" />
                        </div>
                        <div class="clearfix"></div>
                    </div>      
